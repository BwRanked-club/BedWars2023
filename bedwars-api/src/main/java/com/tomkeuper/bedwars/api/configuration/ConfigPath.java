...
public class ConfigPath {
    ...
    public static final String GENERAL_CONFIGURATION_DESPAWNABLE_TIME_BAR_LENGTH = "despawnable-npc.time-bar.length";
    ...
    public static final String GENERAL_CONFIGURATION_ENDER_CHEST_TEAM_SHARED = "ender-chest.team-shared";
    ...
    public static final String GENERAL_CONFIGURATION_STATS_ITEMS_ENCHANTED = GENERAL_CONFIGURATION_STATS_PATH + ".%path%.enchanted";
    public static final String GENERAL_CONFIGURATION_STATS_ITEMS_MODE = GENERAL_CONFIGURATION_STATS_PATH + ".%path%.mode";
    public static final String GENERAL_CONFIGURATION_STATS_FILLER_ENABLED = GENERAL_CONFIGURATION_STATS_PATH + ".filler.enabled";
    public static final String GENERAL_CONFIGURATION_STATS_FILLER_MATERIAL = GENERAL_CONFIGURATION_STATS_PATH + ".filler.material";
    public static final String GENERAL_CONFIGURATION_STATS_FILLER_DATA = GENERAL_CONFIGURATION_STATS_PATH + ".filler.data";
    public static final String GENERAL_CONFIGURATION_STATS_FILLER_ENCHANTED = GENERAL_CONFIGURATION_STATS_PATH + ".filler.enchanted";

    public static final String GENERAL_CONFIGURATION_STATS_MODES_PATH = "stats-modes";
    public static final String GENERAL_CONFIGURATION_STATS_MODES_ALIAS_PATH = GENERAL_CONFIGURATION_STATS_MODES_PATH + ".aliases.%mode%";

    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_PATH = "match-history";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_ENABLED = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".enable";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_ALLOW_OTHERS = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".allow-others";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_ALLOW_IN_GAME = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".allow-in-game";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_COOLDOWN_MS = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".cooldown-ms";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_MAX_RECORDS = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".max-records-per-player";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_PURGE_DAYS = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".purge-older-than-days";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_MODE_LABELS = GENERAL_CONFIGURATION_MATCH_HISTORY_PATH + ".mode-labels";

    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH = "match-history-events";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_ENABLED = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".enable";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_MAX_PER_MATCH = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".max-events-per-match";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_LOG_RESOURCE_DROPS = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".log-resource-drops";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_LOG_RESOURCE_COLLECT = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".log-resource-collect";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_LOG_BUILD_EVENTS = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".log-build-events";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_LOG_PROGRESSION_EVENTS = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".log-progression-events";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_LOG_STAT_EVENTS = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".log-stat-events";
    public static final String GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_LOG_SHOP_OPEN = GENERAL_CONFIGURATION_MATCH_HISTORY_EVENTS_PATH + ".log-shop-open";

    public static final String GENERAL_CONFIGURATION_HISTORY_PATH = "history-gui";
    public static final String GENERAL_CONFIGURATION_HISTORY_GUI_SIZE = GENERAL_CONFIGURATION_HISTORY_PATH + ".inv-size";
    public static final String GENERAL_CONFIGURATION_HISTORY_GUI_SLOTS = GENERAL_CONFIGURATION_HISTORY_PATH + ".entry-slots";
    public static final String GENERAL_CONFIGURATION_HISTORY_ENTRY_MATERIAL = GENERAL_CONFIGURATION_HISTORY_PATH + ".entry.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_ENTRY_DATA = GENERAL_CONFIGURATION_HISTORY_PATH + ".entry.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_ENTRY_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_PATH + ".entry.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_NEXT_MATERIAL = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.next.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_NEXT_DATA = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.next.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_NEXT_SLOT = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.next.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_NEXT_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.next.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PREV_MATERIAL = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.prev.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PREV_DATA = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.prev.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PREV_SLOT = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.prev.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PREV_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.prev.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PAGE_MATERIAL = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.page.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PAGE_DATA = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.page.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PAGE_SLOT = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.page.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_NAV_PAGE_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_PATH + ".navigation.page.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EMPTY_MATERIAL = GENERAL_CONFIGURATION_HISTORY_PATH + ".empty.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EMPTY_DATA = GENERAL_CONFIGURATION_HISTORY_PATH + ".empty.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EMPTY_SLOT = GENERAL_CONFIGURATION_HISTORY_PATH + ".empty.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_EMPTY_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_PATH + ".empty.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_FILLER_ENABLED = GENERAL_CONFIGURATION_HISTORY_PATH + ".filler.enabled";
    public static final String GENERAL_CONFIGURATION_HISTORY_FILLER_MATERIAL = GENERAL_CONFIGURATION_HISTORY_PATH + ".filler.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_FILLER_DATA = GENERAL_CONFIGURATION_HISTORY_PATH + ".filler.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_FILLER_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_PATH + ".filler.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH = "history-events-gui";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_GUI_SIZE = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".inv-size";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_GUI_SLOTS = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".entry-slots";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_ENTRY_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".entry.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_ENTRY_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".entry.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_ENTRY_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".entry.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_NEXT_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.next.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_NEXT_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.next.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_NEXT_SLOT = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.next.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_NEXT_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.next.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PREV_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.prev.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PREV_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.prev.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PREV_SLOT = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.prev.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PREV_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.prev.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PAGE_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.page.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PAGE_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.page.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PAGE_SLOT = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.page.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_PAGE_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.page.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_BACK_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.back.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_BACK_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.back.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_BACK_SLOT = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.back.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_NAV_BACK_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".navigation.back.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_EMPTY_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".empty.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_EMPTY_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".empty.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_EMPTY_SLOT = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".empty.slot";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_EMPTY_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".empty.enchanted";

    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_FILLER_ENABLED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".filler.enabled";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_FILLER_MATERIAL = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".filler.material";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_FILLER_DATA = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".filler.data";
    public static final String GENERAL_CONFIGURATION_HISTORY_EVENTS_FILLER_ENCHANTED = GENERAL_CONFIGURATION_HISTORY_EVENTS_PATH + ".filler.enchanted";
