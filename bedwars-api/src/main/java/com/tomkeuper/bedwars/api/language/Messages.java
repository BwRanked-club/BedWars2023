...
public class Messages {
    ...
    public static String PLAYER_HISTORY_GUI_ENTRY_LORE = PLAYER_HISTORY_GUI_PATH + "-entry-lore";
    public static String PLAYER_HISTORY_GUI_EMPTY_NAME = PLAYER_HISTORY_GUI_PATH + "-empty-name";
    public static String PLAYER_HISTORY_GUI_EMPTY_LORE = PLAYER_HISTORY_GUI_PATH + "-empty-lore";
    public static String PLAYER_HISTORY_GUI_NEXT_NAME = PLAYER_HISTORY_GUI_PATH + "-next-name";
    public static String PLAYER_HISTORY_GUI_NEXT_LORE = PLAYER_HISTORY_GUI_PATH + "-next-lore";
    public static String PLAYER_HISTORY_GUI_PREV_NAME = PLAYER_HISTORY_GUI_PATH + "-prev-name";
    public static String PLAYER_HISTORY_GUI_PREV_LORE = PLAYER_HISTORY_GUI_PATH + "-prev-lore";
    public static String PLAYER_HISTORY_GUI_PAGE_NAME = PLAYER_HISTORY_GUI_PATH + "-page-name";
    public static String PLAYER_HISTORY_GUI_PAGE_LORE = PLAYER_HISTORY_GUI_PATH + "-page-lore";
    public static String PLAYER_HISTORY_GUI_FILLER_NAME = PLAYER_HISTORY_GUI_PATH + "-filler-name";
    public static String PLAYER_HISTORY_GUI_FILLER_LORE = PLAYER_HISTORY_GUI_PATH + "-filler-lore";
    public static String PLAYER_HISTORY_NO_DATA = "history-no-data";
    public static String PLAYER_HISTORY_PLAYER_NOT_FOUND = "history-player-not-found";
    public static String PLAYER_HISTORY_VIEW_OTHER_DENIED = "history-view-other-denied";
    public static String HISTORY_RESULT_WIN = "history-result-win";
    public static String HISTORY_RESULT_LOSE = "history-result-lose";
    public static String PLAYER_HISTORY_EVENTS_GUI_PATH = "history-events";
    public static String PLAYER_HISTORY_EVENTS_GUI_INV_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-inv-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_EMPTY_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-empty-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_EMPTY_LORE = PLAYER_HISTORY_EVENTS_GUI_PATH + "-empty-lore";
    public static String PLAYER_HISTORY_EVENTS_GUI_NEXT_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-next-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_NEXT_LORE = PLAYER_HISTORY_EVENTS_GUI_PATH + "-next-lore";
    public static String PLAYER_HISTORY_EVENTS_GUI_PREV_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-prev-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_PREV_LORE = PLAYER_HISTORY_EVENTS_GUI_PATH + "-prev-lore";
    public static String PLAYER_HISTORY_EVENTS_GUI_PAGE_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-page-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_PAGE_LORE = PLAYER_HISTORY_EVENTS_GUI_PATH + "-page-lore";
    public static String PLAYER_HISTORY_EVENTS_GUI_BACK_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-back-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_BACK_LORE = PLAYER_HISTORY_EVENTS_GUI_PATH + "-back-lore";
    public static String PLAYER_HISTORY_EVENTS_GUI_FILLER_NAME = PLAYER_HISTORY_EVENTS_GUI_PATH + "-filler-name";
    public static String PLAYER_HISTORY_EVENTS_GUI_FILLER_LORE = PLAYER_HISTORY_EVENTS_GUI_PATH + "-filler-lore";
    public static String PLAYER_HISTORY_EVENTS_NO_DATA = "history-events-no-data";
    public static String PLAYER_HISTORY_EVENTS_NO_PERMISSION = "history-events-no-permission";
    public static String PLAYER_HISTORY_EVENT_DEFAULT_NAME = "history-event-default-name";
    public static String PLAYER_HISTORY_EVENT_DEFAULT_LORE = "history-event-default-lore";
    public static String PLAYER_HISTORY_EVENT_TEMPLATE_NAME = "history-event-%type%-name";
    public static String PLAYER_HISTORY_EVENT_TEMPLATE_LORE = "history-event-%type%-lore";
    public static String PLAYER_HISTORY_EVENT_TYPE_NAME = "history-event-type-%type%";
    ...
    public static String FORMATTING_DESPAWNABLE_UTILITY_NPC_TIME_BAR_PREFIX = "format-despawnable-timebar-prefix";
    public static String FORMATTING_DESPAWNABLE_UTILITY_NPC_TIME_BAR_SUFFIX = "format-despawnable-timebar-suffix";
    public static String FORMATTING_DESPAWNABLE_UTILITY_NPC_TIME_BAR_FILLED = "format-despawnable-timebar-filled";
    public static String FORMATTING_DESPAWNABLE_UTILITY_NPC_TIME_BAR_EMPTY = "format-despawnable-timebar-empty";
    public static String FORMATTING_STATS_DATE_FORMAT = "format-stats-time";
    public static String FORMATTING_HISTORY_DATE_FORMAT = "format-history-time";
    ...
    /** Click to Deposit */
    public static String ITEM_DEPOSITED_SUCCESSFULLY = "item-deposited-successfully";
    ...
    public static String GAME_END_MAP_RATING_QUESTION = "game-end-map-rating-question";
    public static String GAME_END_MAP_RATING_STAR = "game-end-map-rating-star";
    public static String GAME_END_MAP_RATING_HOVER = "game-end-map-rating-hover";
    public static String GAME_END_MAP_RATING_SUCCESS = "game-end-map-rating-success";
    public static String GAME_END_MAP_RATING_NOT_AVAILABLE = "game-end-map-rating-not-available";
    public static String GAME_END_MAP_RATING_INVALID = "game-end-map-rating-invalid";
    ...
    public static final String DRAW_TITLE = "draw-title";
    public static final String DRAW_SUBTITLE = "draw-subtitle";
