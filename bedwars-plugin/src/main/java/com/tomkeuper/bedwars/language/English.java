...
public class English extends Language {
    ...
    public English() {
        ...
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_USAGE, "%bw_lang_prefix%&fUsage: &b/bw replacePlayer <arena> <old-player> <new-player>");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_ARENA_NOT_FOUND, "%bw_lang_prefix%&fArena not found.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_OLD_NOT_FOUND, "%bw_lang_prefix%&fCurrent team player not found.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_NEW_NOT_FOUND, "%bw_lang_prefix%&fIncoming player not found.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_NOT_PLAYING, "%bw_lang_prefix%&fThis arena is not running.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_OLD_NOT_ACTIVE, "%bw_lang_prefix%&fThat player is not active on a team in this arena.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_NEW_BUSY, "%bw_lang_prefix%&fThe incoming player is already busy in a match.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_TEAM_FULL, "%bw_lang_prefix%&fThe target team has no free slot for the replacement.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_SAME_PLAYER, "%bw_lang_prefix%&fYou must choose two different players.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_ERROR, "%bw_lang_prefix%&fCould not replace the player right now.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_SUCCESS, "%bw_lang_prefix%&aReplaced &f%bw_old_player_display% &awith &f%bw_new_player_display% &ain &b%bw_team_name% &aon &b%bw_arena%&a.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_BROADCAST, "%bw_lang_prefix%&f%bw_old_player_display% &awas replaced by &f%bw_new_player_display% &ain &b%bw_team_name%&a.");
        yml.addDefault(Messages.COMMAND_REPLACE_PLAYER_REMOVED, "%bw_lang_prefix%&fYou were replaced by &b%bw_new_player_display% &fin &b%bw_team_name%&f. You are now a spectator.");
